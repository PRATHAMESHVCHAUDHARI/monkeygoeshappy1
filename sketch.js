...
function preload(){
  ...
  groundImg = loadAnimation("ground1.png.png") 
...
function setup(){
 createCanvas(600,300);
  ...
  invisiGround = createSprite(100,265,600,7);
...
function draw(){
  ...
  fill("black");
  text("SURVIVAL TIME: "+score, 480, 20);
  ...
  if (gameState === END){
    ...
    stroke("black")
    textSize(30);
    text("GAMEOVER !!!", 220, 40);
    fill("black");
    textSize(15);
    text("PRESS 'R' TO PLAY AGAIN", 230, 60);
